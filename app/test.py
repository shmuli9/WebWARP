...
def trigger_nn(input_path, output_path=None, num_styles=5, scale=1.0, aligned=False):
    """
    ...
    for i in range(num_styles):
        misc.imsave(f"{output_path}/{out_name}_{i}.jpg", output[i])


if __name__ == "__main__":
    print("Initiating neural net")
    trigger_nn("app/WarpGAN/data/example/Josh.jpeg", "app/WarpGAN/result")
